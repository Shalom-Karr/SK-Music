...
- The web app already streams and downloads through Zemer's relay in exactly this situation
...
- A **Stream through Zemer** switch in the filter menu turns it on or off by hand. It stays off unless
...
*(Thanks to the Zemer project — the relay, like the catalog, is theirs.)*
